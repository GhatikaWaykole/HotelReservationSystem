...
public class HotelReservationSystemTest {
    ...
    public void CheckIfHotelAddedProperly() {
            hotelReservation.addHotel("BridegWood", 180,60,4);
            hotelReservation.addHotel("RidgeWood", 220,20,2);
            hotelReservation.addHotel("LakeWood", 300,110,6);
    ...
    public void givenDataHotel_WhenCheapPrice_ShouldReturnTrue(){
        ...
        Assert.assertEquals("BridegWood",cheapHotel);
    }
}
